...
const pluginNamespace = builtPlugin.meta?.namespace ?? "tombi";
const presetDocsByName = {
    ...
    format: {
        href: "./format.md",
        icon: "🔧",
        path: resolve("docs", "rules", "presets", "format.md"),
        publicName: "tombi.configs.format",
    },
    lint: {
        href: "./lint.md",
        icon: "🚦",
        path: resolve("docs", "rules", "presets", "lint.md"),
    ...
    tombiOnly: {
        href: "./tombi-only.md",
        icon: "🧪",
        path: resolve("docs", "rules", "presets", "tombi-only.md"),
