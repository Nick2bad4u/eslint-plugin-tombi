...
const rawHangingReporterFlag =
    process.env["TOMLLINT_VITEST_HANGING_PROCESS_REPORTER"] ??
...
/**
 * Vitest configuration for eslint-plugin-tombi.
 */
    ...
    test: {
        ...
        coverage: {
            ...
            exclude: [
                ...
                "shared",
                "shared/test",
                "src/_internal/tombi-worker.ts", // Covered through worker integration; V8 cannot merge worker-thread instrumentation here.
