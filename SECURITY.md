...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/eslint-plugin-tombi/security/advisories/new>
...
- Keep `eslint-plugin-tombi`, ESLint, TypeScript, and dependencies updated.
