...
Tombi can fetch remote schemas and catalogs. The bridge sets `TOMBI_CACHE_HOME` and a 30-day `TOMBI_CACHE_TTL` by default so repeated ESLint runs do not spam remote schema hosts.
