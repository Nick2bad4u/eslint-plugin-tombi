...
const baseUrl =
    environmentVariables["DOCUSAURUS_BASE_URL"] ?? "/eslint-plugin-tombi/";
const enableExperimentalFaster =
    environmentVariables["DOCUSAURUS_ENABLE_EXPERIMENTAL"] === "true";

const organizationName = "Nick2bad4u";
const projectName = "eslint-plugin-tombi";
const siteOrigin = "https://nick2bad4u.github.io";
const siteUrl = `${siteOrigin}${baseUrl}`;
const siteDescription =
    "Run Tombi from ESLint, report TOML lint and format diagnostics in the same editor and CI stream, and keep Tombi schema cache behavior under control.";
const projectTagline = "TOML diagnostics inside ESLint.";
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            label: "🧪 Bridge Guide",
                            to: "/docs/rules/guides/tombi-bridge",
                        },
                    ],
                    label: "📚 Docs",
                    position: "left",
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            label: "🧪 Tombi Only",
                            to: "/docs/rules/presets/tombi-only",
                        },
                        {
                            label: "🚦 Lint",
                            to: "/docs/rules/presets/lint",
                        },
                        {
                            label: "✅ Check",
                            to: "/docs/rules/presets/check",
                        },
                        {
                            label: "🔧 Format",
                            to: "/docs/rules/presets/format",
                        },
